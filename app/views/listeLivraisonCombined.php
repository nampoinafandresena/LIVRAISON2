...
<main>
    ...
    <h2>📦 Liste des livraisons (détails)</h2>
            ...
            <?php if (!empty($livraisons)) : ?>
                <?php foreach ($livraisons as $l) : ?>
                    <tr>
                        ...
                        <td><?= htmlspecialchars($l['carburant']) ?> Ar</td>
    ...
    <h2>💰 Liste des livraisons (revenu / coût / profit)</h2>
        ...
        <tbody>
            <?php if (!empty($livraisonsR)) : ?>
                ...
                <tr>
                    ...
                    <td class="<?= $l['profit'] >= 0 ? 'profit-positif' : 'profit-negatif' ?>">
                        <?= $l['profit'] ?> Ar
                    </td>
                </tr>
                <?php endforeach; ?>
            <?php else : ?>
                <tr>
                    <td colspan="10">Aucune livraison trouvée</td>
                </tr>
            <?php endif; ?>
        </tbody>
    </table>
